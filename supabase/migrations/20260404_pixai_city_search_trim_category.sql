-- City-wide PixAI search: trim + ilike on city (matches resilient city matching).
-- Category: match selected id OR same display name on the card's category (duplicate category rows).
