...
function runParserSelfChecks() {
  const checks = [
    ...
    parseAvailabilityReply("yes_available") === "yes",
    parseAvailabilityReply("No, not available") === "no",
    parseAvailabilityReply("not_available") === "no",
    parseAvailabilityReply("availability_no") === "no",
    parseAvailabilityReply("Venue declined this slot.") === "no",
