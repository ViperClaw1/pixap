...
export const aiBookingStaticStyles = StyleSheet.create({
  ...
  placeCardSelected: {},
  placeRow: { flexDirection: "row", alignItems: "stretch", gap: 12 },
  placeThumb: {
    width: 112,
    height: 112,
    borderRadius: 12,
  },
  placeTextCol: { flex: 1, minWidth: 0, gap: 8 },
  placeNameRow: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 8 },
  placeName: { fontWeight: "700", fontSize: 16, flex: 1 },
  placeAddressRow: { flexDirection: "row", alignItems: "flex-start", gap: 4, marginTop: 4 },
  placeAddressText: { flex: 1, fontSize: 12, lineHeight: 16 },
  placeTagsRow: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 4 },
  placeTagPill: {
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 999,
